...
// TODO(mdbook, #2181): When converting this WebSocket page, restore TLS
// configuration coverage for `wss://` endpoints. Include how
// `nng_tls_config` is supplied or obtained through the relevant
// dialer/listener and stream APIs, and document hold/reference behavior.
