...
TCP:: TCP (and TCPv6) transport; see the mdBook transport reference
...
TIP: The `nng_device()` function only works with raw mode
...
The library API is documented in the mdBook API reference under `docs/ref/api/`.
