...
| `NNG_EAGAIN`<a name="NNG_EAGAIN"></a>             | 8                       | Try again. Typically for a non-blocking operation that might succeed later.                                                                        |
| `NNG_ENOTSUP`<a name="NNG_ENOTSUP"></a>           | 9                       | Not supported. Perhaps the protocol or transport is not supported, or the operation is not supported with the transport or protocol.              |
...
| `NNG_ESTOPPED`<a name="NNG_ESTOPPED"></a>         | 999                     | Operation stopped. The operation was stopped with [`nng_aio_stop`].                                                                               |
| `NNG_EINTERNAL`<a name="NNG_EINTERNAL"></a>       | 1000                    | An unidentified internal error occurred.                                                                                                          |
